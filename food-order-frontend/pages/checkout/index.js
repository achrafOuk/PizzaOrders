 ...
 console.log('order id',order_id)
  return (
    <>
        ...
        <div className="mt-[5%] h-screen bg-white text-black flex flex-col items-center text-center p-6">
            ...
            <div className='flex'>
                ...
                <Link href={`/fellow-order/${order_id}`} >
                    < a href='' className="ml-[5%] text-white px-4 py-2 bg-blue-600 rounded-full shadow-lg hover:bg-blue-700 focus:outline-none focus:shadow-outline-blue active:bg-blue-800">
